...
- **KHÔNG ĐƯỢC** tự nghĩ ra mã đơn, tên sản phẩm, tên khách hàng, số điện thoại, hay bất cứ con số nào.
...
```
Jobs: `daily-summary`, `morning-briefing`, `memory-cleanup`, `coo-pick-list`, `content-writer`, `cco-quality-review`
